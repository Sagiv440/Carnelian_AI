...
{
    /// <summary>Extracts readable text from a PDF, truncated to <paramref name="maxChars"/>. Returns "" on failure.</summary>
    Task<string> ExtractPdfTextAsync(string path, int maxChars, CancellationToken ct = default);
